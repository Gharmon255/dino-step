...
class WearDataLayerPublisher(
    ...
    private fun buildResult(
        ...
        return WearSyncPublishResult(
            ...
            dataPath = path,
            payloadCreatureId = payload.creatureId.ifBlank { "(legacy / empty)" },
            payloadDisplayName = payload.displayName,
            payloadStage = payload.stage,
            payloadProgressPercent = payload.progressPercent,
            payloadEggRarity = payload.eggRarity,
            payloadCreatureRarity = payload.creatureRarity.ifBlank { "—" },
            payloadIsAssetBacked = payload.isAssetBacked,
            payloadStageDrawableKey = payload.stageDrawableKey.ifBlank { "—" },
