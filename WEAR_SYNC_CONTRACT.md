...
- Supported **asset-backed** slugs: `tiny_raptor`, `triceratops`, `trex`, `stegosaurus`, `brachiosaurus`, `ankylosaurus`, `parasaurolophus`, `spinosaurus`, `pteranodon`, `dilophosaurus`, `carnotaurus`, `mosasaurus`, `pachycephalosaurus`, `allosaurus`, `iguanodon`.
